...
class AllScoresModel
{
    ...
    private function getFormData($season_options, $selected_season)
    {
        ...
        $form = $this->form_factory->create(new AllScoresType($entity),
                                            $entity,
    ...
    private function getTemplateData($selected_season)
    {
        ...
        $club_competition_results_unsorted = $this->query_miscellaneous->getCompetitionResultByDate($season_start_date,
                                                                                                    $season_end_date);
